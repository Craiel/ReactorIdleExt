...
return n+='<span class="description">Transfers <b class="heat">'+nf(r)+"</b> heat per tick to outlets.</span>"},t.prototype.getInfoText=function(){return t.getInfoText(this.tile.getReactor(),this.tile.getMeta())},t.prototype.inputToOutputHeat=function(e){if(e.length>0){var a=Math.min(t.getMaxHeatTransfer(this.reactor,this.tile.getMeta()),this.tile.getHeat())
