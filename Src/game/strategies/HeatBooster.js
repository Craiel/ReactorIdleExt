define(["actions/BuyComponentAction"], function(t) {
    ...
    return e.prototype.calculateHeat = function(e) {
        var i = this.tile.getMeta(),
            a = 10,
            l = this.tile.getWater() * a
        ...
        else if (this.tile.getReactor().getGame().getResearch(i.id + "AutoRebuild")) {
            var n = new t(this.tile, i)
