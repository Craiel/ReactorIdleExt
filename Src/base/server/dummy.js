define([], function() {
    ...
    return e.prototype.init = function() {
        var e = this
        logger.info(t, "Init"), this._isApiLoaded = !1, setTimeout(function() {
            logger.info(t, "API loaded"), e._isApiLoaded = !0, e.loadPurchases()
        }, 2e3)
    ...
    }, e.prototype.loadPurchases = function() {
        var t = this
        setTimeout(function() {
            t.main.getGame().getPurchaseManager().updatePurchases(t.purchases)
        }, 1e3)
